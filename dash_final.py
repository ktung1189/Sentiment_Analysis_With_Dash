...
conn = sqlite3.connect('twitter3.db', check_same_thread=False)

punctuation = [str(i) for i in string.punctuation]


sentiment_colors = {-1: '#EE6066',
                    -0.5: '#FDE74C',
                    0: '#FFE6AC',
                    0.5: '#D0F2DF',
                    1: '#9CEC5B',}
...
app.layout = html.Div(
    [   html.Div(className='container-fluid', children=[html.H2('Live Twitter Sentiment', style={'color':'#CECECE'}),
        ...
        html.Div(className='row', children=[html.Div(id='related-sentiment', children=html.Button('Loading related term...', id='related_term_button'), className='col s12 m6 l6', style={'word-wrap':'break-word'}),
